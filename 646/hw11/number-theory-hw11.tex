...
This was mostly about ranks and the images of $\alpha$ and $\overline{\alpha}$.
I feel like I'm comfortable with it, but I also feel like I'm getting the wrong answers, so I'm not sure.
...
{\Large In the course of doing this assignment, where did you get stuck?
  ...
  I wasn't necessarily stuck anywhere.
...
I suspect my answer to 1 is wrong somehow, but I'm not sure why. It could be something about the gcd conditions, I just didn't have much time this week.
...
\end{ex}
\begin{proof}
  I see one place in the Notes where we did a HyperellipticCurve command for a quartic, but I have no idea how to find a related elliptic curve that gives us something useful.
\end{proof}
