...
\textbf{How do you prefer that I refer to you?} \\
Connor is fine!
\\\\
\textbf{Please list the math classes that you have had which were proof intensive.} \\
Abstract Algebra I \& II, Advanced Calculus I \& II, Topology I (undergraduate level, Moore method), Topology I (graduate level)
\\\\
\textbf{What degree(s) are you currently working on?} \\
Mathematics M.S.
\\\\
\textbf{What ambitions do you have mathematically?} \\
I want to get a Ph.D. with a strong advisor and go on to work in academia as a research mathematician.
\\\\
\textbf{What do you enjoy other than mathematics?} \\
Learning French, reading, philosophy, playing the bass guitar, hanging out with my wife, and combinations of the above.
\\\\
