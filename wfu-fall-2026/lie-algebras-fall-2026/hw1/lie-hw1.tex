...
\begin{proof}
    ...
    We first observe that \textcolor{red}{FILL IN CALCULATIONS} \begin{align*}
         & [x, e] = 2ae - ch \in I \tag{E1} \\
         & [x, f] = -2af + bh \in I \tag{E2} \\
         & [x, h] = -2be + 2cf \in I. \tag{E3}
    \end{align*}
    We now take strategic linear combinations (so that we stay within $I$).
    First, we take $$E4 = bE1 + aE3 = 2abe - bch - 2abe + 2acf = 2acf - bch.$$
    Then $$E5 = E4 + cE2 = 2acf - bch - 2acf + bch = $$
    \textcolor{red}{UNFINISHED}
\end{proof}
