...
\begin{proof}
	...
	This induces a system of equations on the coefficients of a general cubic curve by plugging in values for $x$ and $y$, in order, as follows: \begin{align*}
		...
		a + b + c + d + e + f + g + h + i + j   & = 0.
	\end{align*}
	Then, combining the first and second, third and sixth, fourth and fifth, and seventh and eighth, we get \begin{align*}
		2g + 2j                       & = 0  \\
		2e + 2j                       & = 0  \\
		- 2a - 2c + 2e + 2g - 2h + 2j & = 0  \\
		2a + 2c + 2e + 2g + 2h + 2j   & = 0.
	\end{align*}
	Combining the first and second, then third and fourth, then dividing the third and fourth by two, we get \begin{align*}
		2g + 2e + 4j & = 0  \\
		2e + 2g + 2j & = 0.
	\end{align*}
  Now we can subtract these two and make our conclusion: \begin{align*}
    2j = 0 \implies j = 0.
  \end{align*}
\end{proof}
